...
public class Main {
  ...
  // Hashmap would be the good choice because it's essetial for real-time applications.
  ...
  // What would be a good choice of data structure?
  // It would be either a linkedlist or arraylist to add data to the end or accessing by their position.
  ...
  // What would be a good choice of data structure?
  // It would be either a linkelist or arraylist.
}